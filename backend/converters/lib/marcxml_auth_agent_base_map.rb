module MarcXMLAuthAgentBaseMap
  ...
  def BASE_RECORD_MAP(opts = {:import_events => false, :import_subjects => false, :import_related_agents => false})
...

    {
      ...
      "//datafield[@tag='100' and (@ind1='1' or @ind1='0')]" => {
        :obj => :agent_person,
        :map => agent_person_base(import_events, import_subjects, import_related_agents)
      },
      # AGENT CORPORATE ENTITY
      "//datafield[@tag='110' or @tag='111']" => {
        :obj => :agent_corporate_entity,
        :map => agent_corporate_entity_base(import_events, import_subjects, import_related_agents)
      },
      # AGENT FAMILY
      "//datafield[@tag='100' and @ind1='3']" => {
        :obj => :agent_family,
        :map => agent_family_base(import_events, import_subjects, import_related_agents)
      }
    }
  end

  def agent_person_base(import_events, import_subjects, import_related_agents)
    p = {
    ...
    }.merge(shared_subrecord_map(import_events, import_subjects, import_related_agents))
  ...
  def agent_corporate_entity_base(import_events, import_subjects, import_related_agents)
    c = {
  ...
  def agent_family_base(import_events, import_subjects, import_related_agents)
    f = {
  ...
  def shared_subrecord_map(import_events, import_subjects, import_related_agents)
    h = {
